...
<body>
                    ...
                    <form method="post" action="<?php echo $_SERVER['PHP_SELF'];?>">
                        <nav class="level" style="margin-left: 40px; margin-right: 40px">
                            <div class="level-item">   
                                <font color=#E84D6E>Aluno:</font>&nbsp;&nbsp;&nbsp;
                                <input class="input is-danger" type="text" placeholder="*Opcional" name='nome'>
                            </div>
                            <div class="level-item">   
                                <font color=#E84D6E>Turma:</font>&nbsp;&nbsp;&nbsp;
                            ...
                            <div class="level-item">   
                                <button type="submit" value="submit" class="button is-primary is-fullwidth" style="width: 250px; background-color: #E84D6E">
                                    Pesquisar
                                </button>
                            </div>
                        </nav>
                ...
                <center>
                    <table border=1 class="table">
                        ...
                        <tr>
                            ...
                            <td>
                            <center>
                                <a href="emitir.php?idaluno=<?php echo $dado["idaluno"];?>">
                                    <span class="tag is-primary" style="width: 150px; background-color: #E84D6E">Emitir ocorrência</span>
                                </a>
                            </center>
                            </td>
                        </tr>
    ...
    <ul>
        ...
        <li><p align="center"><a href="" >Emissão de Ocorrências</a></p></li>
